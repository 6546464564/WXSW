...
interface BookmarkDao {
    ...
    @get:Query(
        """
        select * from bookmarks order by bookName collate nocase, bookAuthor collate nocase, chapterIndex, chapterPos
    """
    )
    val all: List<Bookmark>

    @Query("select * from bookmarks order by bookName collate nocase, bookAuthor collate nocase, chapterIndex, chapterPos")
