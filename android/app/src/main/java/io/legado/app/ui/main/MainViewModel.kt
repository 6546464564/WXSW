...
class MainViewModel(application: Application) : BaseViewModel(application) {
    ...
    // 万象书屋 fix: 原 ConcurrentHashMap.newKeySet() 返回的 KeySetView, 其 size/isEmpty 在 API 24+
    // 才有 (minSdk 21 触发 NewApi error), 改用 newSetFromMap 拿到通用 Set 接口
