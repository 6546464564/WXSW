...
object ThemeConfig {
    ...
    fun saveDayTheme(context: Context, name: String) {
        val primary =
            context.getPrefInt(PreferKey.cPrimary, context.getCompatColor(R.color.wanxiang_primary))
        val accent =
            context.getPrefInt(PreferKey.cAccent, context.getCompatColor(R.color.wanxiang_accent))
        val background =
    ...
    fun applyTheme(context: Context) = with(context) {
        when {
            ...
            AppConfig.isNightTheme -> {
                ...
                val primary =
                    getPrefInt(PreferKey.cPrimary, getCompatColor(R.color.wanxiang_primary))
                val accent =
                    getPrefInt(PreferKey.cAccent, getCompatColor(R.color.wanxiang_accent))
                var background =
